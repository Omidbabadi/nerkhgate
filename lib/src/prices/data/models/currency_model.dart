...
class CurrencyModel extends Currency {
  ...
  factory CurrencyModel.fromJson(String source, ItemTypes itemType) =>
      CurrencyModel.fromMap(jsonDecode(source) as DataMap, itemType);
  factory CurrencyModel.fromMap(DataMap map, ItemTypes itemType) {
    return CurrencyModel(
